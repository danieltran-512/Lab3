...
class UpdateBookInfo extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get('https://evening-island-00479.herokuapp.com/api/books/'+this.props.match.params.id)
      .then(res => {
        ...
        this.setState({
          ...
          published_date: (new Date(res.data.published_date)).toISOString().slice(0, 10),
